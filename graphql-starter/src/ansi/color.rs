...
impl Color {
    ...
    pub(super) fn parse_8bit_or_rgb<I>(mut iter: I) -> Result<Self, Error>
    where
        I: Iterator<Item = Result<u8, ParseIntError>>,
    {
        let code = iter
            .next()
            .transpose()?
            .ok_or_else(super::invalid_ansi("Missing 2 or 5"))?;
        Ok(match code {
            5 => {
                let color = iter
                    .next()
            ...
            2 => {
                ...
                let r = r.ok_or_else(super::invalid_ansi("Missing ANSI red"))?;
...
impl FourBitColor {
    pub(super) fn is_bright(self) -> bool {
        matches!(
            self,
            Self::BrightBlack
                | Self::BrightRed
...
#[derive(Debug, Copy, Clone, Eq, PartialEq)]
pub(super) struct EightBitColor {
    code: u8,
}
...
impl fmt::Display for EightBitColor {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        const COLORS: [&str; 256] = [
            "#000", "#a00", "#0a0", "#a60", "#00a", "#a0a", "#0aa", "#aaa", "#555", "#f55", "#5f5", "#ff5", "#55f",
            "#f5f", "#5ff", "#fff", "#000", "#00005f", "#000087", "#0000af", "#0000d7", "#00f", "#005f00", "#005f5f",
            "#005f87", "#005faf", "#005fd7", "#005fff", "#008700", "#00875f", "#008787", "#0087af", "#0087d7",
            "#0087ff", "#00af00", "#00af5f", "#00af87", "#00afaf", "#00afd7", "#00afff", "#00d700", "#00d75f",
            "#00d787", "#00d7af", "#00d7d7", "#00d7ff", "#0f0", "#00ff5f", "#00ff87", "#00ffaf", "#00ffd7", "#0ff",
            ...
            "#d7d7af", "#d7d7d7", "#d7d7ff", "#d7ff00", "#d7ff5f", "#d7ff87", "#d7ffaf", "#d7ffd7", "#d7ffff", "#f00",
            "#ff005f", "#ff0087", "#ff00af", "#ff00d7", "#f0f", "#ff5f00", "#ff5f5f", "#ff5f87", "#ff5faf", "#ff5fd7",
            ...
            "#ffd7ff", "#ff0", "#ffff5f", "#ffff87", "#ffffaf", "#ffffd7", "#fff", "#080808", "#121212", "#1c1c1c",
            "#262626", "#303030", "#3a3a3a", "#444", "#4e4e4e", "#585858", "#626262", "#6c6c6c", "#767676", "#808080",
            "#8a8a8a", "#949494", "#9e9e9e", "#a8a8a8", "#b2b2b2", "#bcbcbc", "#c6c6c6", "#d0d0d0", "#dadada",
            "#e4e4e4", "#eee",
        ];
